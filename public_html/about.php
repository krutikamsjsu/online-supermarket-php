				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 about-video-left">
							...
							<h1>
								We’ve made a place <br>
								that will change your life
							</h1>
							<p>
								<span>We are here to ease your life</span>
							</p>
							<p>
								Get all kinds of Indian stuff no matter where you are
							</p>
							<a class="primary-btn" href="products.php">Get Started Now</a>
						</div>
						<div class="col-lg-6 about-video-right justify-content-center align-items-center d-flex relative">
							<div class="overlay overlay-bg"></div>
							<a class="play-btn" href="https://www.youtube.com/watch?v=s_FfybNLAFY"><img class="img-fluid mx-auto" src="img/play-btn.png" alt=""></a>
						</div>
					</div>
				</div>
			</section>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-lg-6 home-about-left no-padding">
							<img class="mx-auto d-block img-fluid" src="img/gro.png" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							...
							<p>
								Customize orders are done,we can go to any extent to deliver the things you want..
							</p>
