<?php
    ...
    if(isset($_POST['rating']) && $_POST['rating']>0){
        ...
        if(isset($_COOKIE['user_cookie'])){
            ...
            $sql="INSERT INTO rating (email, item, rating, review) VALUES ('$email','Grinder',$rating,'$review')";
        }
    ...
    if(isset($_COOKIE['user_cookie'])){
        ...
        $query="SELECT u.first_name, r.email, r.rating, r.review FROM rating r, user u WHERE r.email=u.email AND item = 'Grinder'" ;
    ...
    if(isset($_COOKIE['Product_cookie'])){
        ...
        if(in_array("Grinder",$product)){
            $index = array_search("Grinder", $product);
    ...
    function addToCart(){
        ...
        array_push($cart, "Grinder");   
        setcookie("AddToCart_cookie",serialize($cart),time()+60*60*24*5);
    }
    array_push($product, "Grinder");
    setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
    setcookie('GrinderVisit', isset($_COOKIE['GrinderVisit']) ? ++$_COOKIE['GrinderVisit'] : 1,time()+60*60*24*5);
?>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
							<img class="mx-auto d-block img-fluid" src="img/grinder.jpg" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							...
							<p>
								electric grinders,Hand made grinders,magic grinders and many more..
							</p>
							<a class="primary-btn text-uppercase" href="cart_working.php" value="grinder" onclick="addToCart();">Add to Cart</a>
							<form id="myForm" action="grinder.php" method="post" class="form-area contact-form text-right">
