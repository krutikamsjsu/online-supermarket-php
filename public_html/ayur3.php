...
if(isset($_COOKIE['Product_cookie'])){
    ...
    if(in_array("Product3",$product)){
        $index = array_search("Product3", $product);
...
array_push($cart, "Ayurveda Elixir");

setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
setcookie("AddToCart_cookie",serialize($cart),time()+60*60*24*5);
setcookie('product3Visit', isset($_COOKIE['product3Visit']) ? ++$_COOKIE['product3Visit'] : 1,time()+60*60*24*5);
?>
<!DOCTYPE html>
...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Ayurveda Elixirs & Special potions</title>
			...
			<div class="container-fluid">
				<div class="row align-items-center">
					<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
					    <p></p>
						<img class="mx-auto d-block img-fluid" src="img/ayur3.jpg" alt="">

					<div class="bottom-part">
					    <p></p>
									<h5 name="pricetag">$7.00</h5>
					...
					<div class="col-lg-6 home-about-right no-padding">
						...
						<p>
							<ul>
								...
								<li>Try some of our natural elixis</li>
								<li>specially made for you!</li>
							</ul>
						</p>
						<a class="primary-btn text-uppercase" href="cart_working.php" value="elixirs">Add to Cart</a>
