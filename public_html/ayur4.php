...
if(isset($_COOKIE['Product_cookie'])){
    ...
    if(in_array("Product4",$product)){
        $index = array_search("Product4", $product);
...
array_push($cart, "Ayurveda Garden Plant");

setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
setcookie("AddToCart_cookie",serialize($cart),time()+60*60*24*5);
setcookie('product4Visit', isset($_COOKIE['product4Visit']) ? ++$_COOKIE['product4Visit'] : 1,time()+60*60*24*5);
?>
<!DOCTYPE html>
			...
			<div class="container-fluid">
				<div class="row align-items-center">
					<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
					    <p></p>
						<img class="mx-auto d-block img-fluid" src="img/ayur4.jpg" alt="">
					...
					<div class="col-lg-6 home-about-right no-padding">
						...
						<a class="primary-btn text-uppercase" href="cart_working.php" value="garden">Add to Cart</a>
						<form id="myForm" action="ayur4.php" method="post" class="form-area contact-form text-right">
