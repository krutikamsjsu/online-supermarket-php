...
if(isset($_COOKIE['Product_cookie'])){
    ...
    if(in_array("Product6",$product)){
        $index = array_search("Product6", $product);
...
array_push($product, "Product6");
array_push($cart, "Therapy Massage");

setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
setcookie("AddToCart_cookie",serialize($cart),time()+60*60*24*5);
setcookie('product6Visit', isset($_COOKIE['product6Visit']) ? ++$_COOKIE['product6Visit'] : 1,time()+60*60*24*5);
?>
<!DOCTYPE html>
			...
			<div class="container-fluid">
				<div class="row align-items-center">
					<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
					    <p></p>
						<img class="mx-auto d-block img-fluid" src="img/ayur6.jpeg" alt="" width="60px" height="60px">

					<div class="bottom-part">
					    <p></p>
									<h5> $70.00 - $120.00 per massage</h5>
					...
					<div class="col-lg-6 home-about-right no-padding">
						...
						<p>
							<ul>
								<li>Often feel stressed?
.</li>
								<li>Come and experience how divinity feels,
								</li>
								<li>have a massage and forget everything else</li>
							</ul>
						</p>
						<a class="primary-btn text-uppercase" href="cart_working.php" value="massage">Add to Cart</a>
