...
if(isset($_COOKIE['Product_cookie'])){
    ...
    if(in_array("Product5",$product)){
        $index = array_search("Product5", $product);
...
array_push($cart, "Yoga Session");

setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
setcookie("AddToCart_cookie",serialize($cart),time()+60*60*24*5);
setcookie('product5Visit', isset($_COOKIE['product5Visit']) ? ++$_COOKIE['product5Visit'] : 1,time()+60*60*24*5);
?>
<!DOCTYPE html>
...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Yoga for a healthy lifestyle</title>
			...
			<div class="container-fluid">
				<div class="row align-items-center">
					<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
					    <p></p>
						<img class="mx-auto d-block img-fluid" src="img/ayur5.jpeg" alt="">

					<div class="bottom-part">
					    <p></p>
									<h5> $40.00 per training session</h5>
					...
					<div class="col-lg-6 home-about-right no-padding">
						...
						<p>
							<ul>
								<li>Do you often feel drained and loss of energy?
						...
						<a class="primary-btn text-uppercase" href="cart_working.php" value="yoga">Add to Cart</a>
