<?php
    ...
    array_push($trace, "Essential Oils");
    ...
    if(isset($_POST['rating']) && $_POST['rating']>0){
        ...
        if(isset($_COOKIE['user_cookie'])){
            ...
            $sql="INSERT INTO rating (email, item, rating, review) VALUES ('$email','oils',$rating,'$review')";
        }
    ...
    if(isset($_COOKIE['user_cookie'])){
        ...
        $query="SELECT u.first_name, r.email, r.rating, r.review FROM rating r, user u WHERE r.email=u.email AND item = 'oils'" ;
    ...
    if(isset($_COOKIE['Product_cookie'])){
        ...
        if(in_array("Product1",$product)){
            $index = array_search("Product2", $product);
    ...
    array_push($cart, "Essential Oils");

    setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
    setcookie("AddToCart_cookie",serialize($cart),time()+60*60*24*5);
    setcookie('product2Visit', isset($_COOKIE['product2Visit']) ? ++$_COOKIE['product2Visit'] : 1,time()+60*60*24*5);
?>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
							<img class="mx-auto d-block img-fluid" src="img/ayur2.jpg" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							...
							<p>
								Try natural oils to relieve pain
							</p>
						<a class="primary-btn text-uppercase" href="cart_working.php" value="oils">Add to Cart</a>
							<form id="myForm" action="ayur2.php" method="post" class="form-area contact-form text-right">
