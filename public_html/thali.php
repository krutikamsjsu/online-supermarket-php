...
include("conection.php");
    ...
    if(isset($_POST['rating']) && $_POST['rating']>0){
        ...
        if(isset($_COOKIE['user_cookie'])){
            ...
            $sql="INSERT INTO rating (email, item, rating, review) VALUES ('$email','Thali',$rating,'$review')";
        }
    ...
    if(isset($_COOKIE['user_cookie'])){
        ...
        $query="SELECT u.first_name, r.email, r.rating, r.review FROM rating r, user u WHERE r.email=u.email AND item = 'Thali'" ;
    ...
    if(isset($_COOKIE['Product_cookie'])){
        ...
        if(in_array("Thali",$product)){
            $index = array_search("Thali", $product);
    ...
    function addToCart(){
        ...
        array_push($cart, "Thali");   
        setcookie("AddToCart_cookie",serialize($cart),time()+60*60*24*5);
    }
    array_push($product, "Thali");
    setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
    setcookie('ThaliVisit', isset($_COOKIE['ThaliVisit']) ? ++$_COOKIE['ThaliVisit'] : 1,time()+60*60*24*5);
?>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
							<img class="mx-auto d-block img-fluid" src="img/thali.jpg" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							<h1>Thali</h1>
							<h5>
								Get good nice dine in copper plate
							</h5>
							<p>
								contains bowls , spooons and many more
							</p>
						<a class="primary-btn text-uppercase" href="cart_working.php" value="thali" onclick="addToCart();">Add to Cart</a>
							<form id="myForm" action="thali.php" method="post" class="form-area contact-form text-right">
