<?php
    ...
    if(isset($_POST['rating']) && $_POST['rating']>0){
        ...
        if(isset($_COOKIE['user_cookie'])){
            ...
            $sql="INSERT INTO rating (email, item, rating, review) VALUES ('$email','Cooker',$rating,'$review')";
        }
    ...
    if(isset($_COOKIE['user_cookie'])){
        ...
        $query="SELECT u.first_name, r.email, r.rating, r.review FROM rating r, user u WHERE r.email=u.email AND item = 'Cooker'" ;
    ...
    if(isset($_COOKIE['Product_cookie'])){
        ...
        if(in_array("Cooker",$product)){
            $index = array_search("Cooker", $product);
    ...
    function addToCart(){
        ...
        array_push($cart, "Cooker");   
        setcookie("AddToCart_cookie",serialize($cart),time()+60*60*24*5);
    }
    array_push($product, "Cooker");
    setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
    setcookie('CookerVisit', isset($_COOKIE['CookerVisit']) ? ++$_COOKIE['CookerVisit'] : 1,time()+60*60*24*5);
?>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
							<img class="mx-auto d-block img-fluid" src="img/cooker.jpg" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							...
							<p>
								preasure cookers,steamers,rice cooker and may more..
							</p>
							<a class="primary-btn text-uppercase" href="cart_working.php" value="cooker" onclick="addToCart();">Add to Cart</a>
							<form id="myForm" action="cooker.php" method="post" class="form-area contact-form text-right">
