<?php
    ...
    if(isset($_POST['rating']) && $_POST['rating']>0){
        ...
        if(isset($_COOKIE['user_cookie'])){
            ...
            $sql="INSERT INTO rating (email, item, rating, review) VALUES ('$email','mcasual',$rating,'$review')";
        }
    ...
    if(isset($_COOKIE['user_cookie'])){
        ...
        $query="SELECT u.first_name, r.email, r.rating, r.review FROM rating r, user u WHERE r.email=u.email AND item = 'mcasual'" ;
    ...
    if(isset($_COOKIE['Product_cookie'])){
        ...
        if(in_array("Mcasual",$product)){
            $index = array_search("Mcasual", $product);
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
							<img class="mx-auto d-block img-fluid" src="img/mcasual.jpg" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							<h1>Mens Casual</h1>
							<h5>
								Different Types of Mens casual attires are available here
							</h5>
							<p>
										dhothis,lungis,shorts....etc
							</p>
						<a class="primary-btn text-uppercase" href="cart_working.php" value="oils" onclick="addToCart();">Add to Cart</a>
							<form id="myForm" action="mcasual.php" method="post" class="form-area contact-form text-right">
