<?php
    ...
    if(isset($_POST['rating']) && $_POST['rating']>0){
        ...
        if(isset($_COOKIE['user_cookie'])){
            ...
            $sql="INSERT INTO rating (email, item, rating, review) VALUES ('$email','fruits',$rating,'$review')";
        }
    ...
    if(isset($_COOKIE['user_cookie'])){
        ...
        $query="SELECT u.first_name, r.email, r.rating, r.review FROM rating r, user u WHERE r.email=u.email AND item = 'fruits'" ;
    ...
    setcookie('FruitsVisit', isset($_COOKIE['FruitsVisit']) ? ++$_COOKIE['FruitsVisit'] : 1,time()+60*60*24*5);
...
<html lang="zxx" class="no-js">
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>CMPE-272-Online-Shopping-Portal</title>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -110px;">
							<img class="mx-auto d-block img-fluid" src="img/fruits.png" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							<h1>FRUITS</h1>
							<h5>
								Different Types of fruits in one pack
							</h5>
							<p>
								Fruits available - Mango, Orange, Grapes, Melons, Bananas, different types of berries
							</p>
							<a class="primary-btn text-uppercase" style="margin-top:20px;" href="#">Add to Cart</a>
							<form id="myForm" action="fruits.php" method="post" class="form-area contact-form text-right">
