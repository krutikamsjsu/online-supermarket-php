<?php
    ...
    if(isset($_POST['rating']) && $_POST['rating']>0){
        ...
        if(isset($_COOKIE['user_cookie'])){
            ...
            $sql="INSERT INTO rating (email, item, rating, review) VALUES ('$email','vegetables',$rating,'$review')";
        }
    ...
    if(isset($_COOKIE['user_cookie'])){
        ...
        $query="SELECT u.first_name, r.email, r.rating, r.review FROM rating r, user u WHERE r.email=u.email AND item = 'vegetables'" ;
    ...
    setcookie('VegetablesVisit', isset($_COOKIE['VegetablesVisit']) ? ++$_COOKIE['VegetablesVisit'] : 1,time()+60*60*24*5);
?>
            ...
            <section class="home-about-area" style="margin-top:30px;margin-bottom:50px;">
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -110px;">
							<img class="mx-auto d-block img-fluid" src="img/vegetables.png" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							<h1>VEGETABLES</h1>
							<h5>
								Different Types of vegetables in one pack
							</h5>
							<p>
								Vegetables available - Okra, Bottle Guard, Spinach, Avaocados, Onions, Tomatoes, Zuccini, Eggplant
							</p>
							<a class="primary-btn text-uppercase" href="cart_working.php" value="oils" onclick="addToCart();">Add to Cart</a>
							<form id="myForm" action="vegetables.php" method="post" class="form-area contact-form text-right">
