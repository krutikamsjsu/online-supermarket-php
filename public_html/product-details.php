				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="product-details.html"> Product Details</a></p>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6">
							<div class="single-price">
								<div class="top-part">
									<h1 class="package-no">
										<img class="mx-auto" src="img/pr1.png" alt="">
									</h1>
									<h4>Personal</h4>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-price">
								<div class="top-part">
									<h1 class="package-no">
										<img class="mx-auto" src="img/pr2.png" alt="">
									</h1>
									<h4>Small Team</h4>
									<p>For the individuals</p>
								</div>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-price">
								<div class="top-part">
									<h1 class="package-no">
										<img class="mx-auto" src="img/pr3.png" alt="">
									</h1>
									<h4>Large Team</h4>
									<p>For the individuals</p>
								</div>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-price">
								<div class="top-part">
									<h1 class="package-no">
										<img class="mx-auto" src="img/pr4.png" alt="">
									</h1>
									<h4>Enterprise</h4>
									<p>For the individuals</p>
								</div>
