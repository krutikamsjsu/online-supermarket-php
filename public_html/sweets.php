<?php
    ...
    if(isset($_POST['rating']) && $_POST['rating']>0){
        ...
        if(isset($_COOKIE['user_cookie'])){
            ...
            $sql="INSERT INTO rating (email, item, rating, review) VALUES ('$email','sweets',$rating,'$review')";
        }
    ...
    if(isset($_COOKIE['user_cookie'])){
        ...
        $query="SELECT u.first_name, r.email, r.rating, r.review FROM rating r, user u WHERE r.email=u.email AND item = 'sweets'" ;
    ...
    setcookie('SweetsVisit', isset($_COOKIE['SweetsVisit']) ? ++$_COOKIE['SweetsVisit'] : 1,time()+60*60*24*5);
?>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
							<img class="mx-auto d-block img-fluid" src="img/sweets.png" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							<h1>Sweets</h1>
							<h5>
								Different Types of Sweets in one pack
							</h5>
							<p>
								Sweets available - Kaju Katli, Motichur Laddu, Ghewar, Jalebi, Rabdi, Gulab Jamun, Rasgulla, Sheera, Peda
							</p>
							<a class="primary-btn text-uppercase" href="cart_working.php" value="oils" onclick="addToCart();">Add to Cart</a>
							<form id="myForm" action="sweets.php" method="post" class="form-area contact-form text-right">
