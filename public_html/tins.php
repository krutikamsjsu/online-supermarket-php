...
include("conection.php");
    ...
    if(isset($_POST['rating']) && $_POST['rating']>0){
        ...
        if(isset($_COOKIE['user_cookie'])){
            ...
            $sql="INSERT INTO rating (email, item, rating, review) VALUES ('$email','Tin',$rating,'$review')";
        }
    ...
    if(isset($_COOKIE['user_cookie'])){
        ...
        $query="SELECT u.first_name, r.email, r.rating, r.review FROM rating r, user u WHERE r.email=u.email AND item = 'Tin'" ;
    ...
    if(isset($_COOKIE['Product_cookie'])){
        ...
        if(in_array("Tin",$product)){
            $index = array_search("Tin", $product);
    ...
    array_push($product, "Tin");
    setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
    setcookie('TinVisit', isset($_COOKIE['TinVisit']) ? ++$_COOKIE['TinVisit'] : 1,time()+60*60*24*5);
?>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
							<img class="mx-auto d-block img-fluid" src="img/tins.jpg" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							<h1>Tins</h1>
							<h5>
							Store your food with comfort
							</h5>
							<p>
								steel,glass,mud and many more..
							</p>
						<a class="primary-btn text-uppercase" href="cart_working.php" value="tin" onclick="addToCart();">Add to Cart</a>
							<form id="myForm" action="tins.php" method="post" class="form-area contact-form text-right">
