...
if(isset($_COOKIE['Product_cookie'])){
    ...
    if(in_array("Product10",$product)){
        $index = array_search("Product10", $product);
...
array_push($product, "Product10");
array_push($cart, "On demand items");

setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
setcookie("AddToCart_cookie",serialize($cart),time()+60*60*24*5);
setcookie('product10Visit', isset($_COOKIE['product10Visit']) ? ++$_COOKIE['product10Visit'] : 1,time()+60*60*24*5);
?>
<!DOCTYPE html>
			...
			<div class="container-fluid">
				<div class="row align-items-center">
					<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
					    <p></p>
						<img class="mx-auto d-block img-fluid" src="img/ayur10.jpeg" alt="">
