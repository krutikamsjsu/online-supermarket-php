...
if(isset($_COOKIE['Product_cookie'])){
    ...
    if(in_array("Product7",$product)){
        $index = array_search("Product7", $product);
...
array_push($product, "Product7");
array_push($cart, "Recipe Book");

setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
setcookie("AddToCart_cookie",serialize($cart),time()+60*60*24*5);
setcookie('product7Visit', isset($_COOKIE['product7Visit']) ? ++$_COOKIE['product7Visit'] : 1,time()+60*60*24*5);
?>
<!DOCTYPE html>
			...
			<div class="container-fluid">
				<div class="row align-items-center">
					<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
					    <p></p>
						<img class="mx-auto d-block img-fluid" src="img/ayur7.jpeg" alt="">

					<div class="bottom-part">
					    <p></p>
									<h5>Recipe books from $20.00</h5>
									<!--<a class="primary-btn text-uppercase" href="ayur1.html">Buy Now</a>-->
					</div>
					</div>
					<div class="col-lg-6 home-about-right no-padding">
						<h1>Healthy Recipes</h1>
						<h5>Recipe books for you
						</h5>
						<p>
							<ul>
						...
						<a class="primary-btn text-uppercase"  href="cart_working.php" value="recipe">Add to Cart</a>
