				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="services.html"> News</a></p>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-offered-service">
								...
								<p>
									Get all items in the same place.
								</p>
						...
						<div class="col-lg-4">
							<div class="single-offered-service">
								...
								<a href="#">
									<h4>Get what you need anywhere any time</h4>
								</a>
								<p>
									We also deliver to remote areas.Our aim to reach you anywhere anytime when you need us.
								</p>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-offered-service">
								<img class="img-fluid" src="img/speed.jpg" alt="">
								<a href="#">
									<h4>Fast Delivery</h4>
								</a>
								<p>
									We try our best to deliver any product in 2 days.Single day delivery is also available(conditions apply)
								</p>
							</div>
						</div>
					</div>
