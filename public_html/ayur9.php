...
if(isset($_COOKIE['Product_cookie'])){
    ...
    if(in_array("Product9",$product)){
        $index = array_search("Product9", $product);
...
array_push($product, "Product9");
array_push($cart, "Wellness Center");

setcookie("Product_cookie",serialize($product),time()+60*60*24*5);
setcookie("AddToCart_cookie",serialize($cart),time()+60*60*24*5);
setcookie('product9Visit', isset($_COOKIE['product9Visit']) ? ++$_COOKIE['product9Visit'] : 1,time()+60*60*24*5);
?>
			...
			<div class="container-fluid">
				<div class="row align-items-center">
					<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
					    <p></p>
						<img class="mx-auto d-block img-fluid" src="img/ayur9.jpeg" alt="">

					<div class="bottom-part">
					    <p></p>
									<h5>Rooms available for 2D/2N- $100.00 onwards</h5>
									<h5>Contact for more details on bookings</h5>
					...
					<div class="col-lg-6 home-about-right no-padding">
						...
						<a class="primary-btn text-uppercase"  href="cart_working.php" value="wellness">Add to Cart</a>
