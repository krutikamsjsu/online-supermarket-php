<?php
    ...
    setcookie('SpicesVisit', isset($_COOKIE['SpicesVisit']) ? ++$_COOKIE['SpicesVisit'] : 1,time()+60*60*24*5);
?>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-3 col-md-offset-5 container-fluid home-about-left no-padding" style="margin-top: -140px;">
							<img class="mx-auto d-block img-fluid" src="img/spices.png" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							<h1>SPICES</h1>
							<h5>
								Different Types of SPices in one pack
							</h5>
							<p>
								Spices available - Fenugreek, Black Pepper, Cumin, Nutmeg, Saffron, Cinnamon, Cardamom, Caraway, Bay Leaf, Mustard, Sesame
							</p>
							<a class="primary-btn text-uppercase" href="cart_working.php" value="oils" onclick="addToCart();">Add to Cart</a>
							<form id="myForm" action="spices.php" method="post" class="form-area contact-form text-right">
